...
def parse_args():
    ...
    parser.add_argument("--contrastive", action="store_true", help="your GPU id")
...
if __name__ == "__main__":
    ...
    command = ["accelerate", "launch", "--gpu_ids", f"{args.GPU_ID}", "textual_inversion_decomposed.py",
    ...
    if not args.contrastive:
        command.remove("--contrastive")
    exit_code = sp.run(command)
